...
function cmdUseKey(positional, flags) {
    ...
    if (!savedTo) {
        ...
        error(`Could not save credentials to ${(0, credentials_js_1.credentialsPath)()} (persistence disabled or directory not writable). Use: export LIGHTNING_WALLET_API_KEY=${key}`);
    }
